...
vignette: "%\\VignetteEncoding{UTF-8} %\\VignetteIndexEntry{Bfiat: The Bfiat package: modelling trawling effects in the Dutch part of the Northsea} %\\VignetteEngine{knitr::rmarkdown}\n"
editor_options:
  markdown:
    wrap: sentence
---
