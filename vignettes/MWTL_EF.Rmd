...
vignette: "%\\VignetteEncoding{UTF-8} %\\VignetteIndexEntry{Bfiat: Modelling trawling
  effects on ecosystem functioning - model parameterisation} %\\VignetteEngine{knitr::rmarkdown}\n"
editor_options:
  markdown:
    wrap: sentence
---
