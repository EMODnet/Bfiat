...
Function *density_perturb* estimates densities at selected times, while *density_trawl* estimates the density after the n-th trawling event.

```{r, echo=FALSE, comment=NA}
Def_fun(density_perturb)
Def_fun(density_trawl)
```
